    ...
    return (
        ...
        <div className={`${scroll ? "navbar-body scroll" : "navbar-body" }`}>
            ...
            <NavHashLink smooth to="/#landing">
                ...
                <div className='nav-logo-bg'></div>
            </NavHashLink>
            <NavHashLink className='nav-link' style={{textDecoration:'none',color:'#FFF'}} smooth to="/#about">
                <p>about</p>
            </NavHashLink>
            <NavHashLink className='nav-link' style={{textDecoration:'none',color:'#FFF'}} smooth to="/#services">
                <p>services</p>
            </NavHashLink>
            <NavHashLink className='nav-link' style={{textDecoration:'none',color:'#FFF'}} smooth to="/#booking">
                <p>booking</p>
            </NavHashLink>
            <NavHashLink className='nav-link' style={{textDecoration:'none',color:'#FFF'}} smooth to="/#gallery">
                <p>gallery</p>
            </NavHashLink>
            <a className='nav-social-link' href='http://instagram.com/arianailslangley' target="_blank">
            ...
            <a className='nav-social-link' href='http://facebook.com/arianailslangley' target="_blank">
                <svg width="24" height="24" viewBox="0 0 24 24">
